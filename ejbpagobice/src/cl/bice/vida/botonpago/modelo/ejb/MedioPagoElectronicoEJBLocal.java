...
@Local
public interface MedioPagoElectronicoEJBLocal {
    /*
     * Constantes Publicas
     */
    ...
    String crearConfirmacionConXmlSeleccionado(String xmlResumenSeleccionado, int idCanal);
    ...
    List<ReporteAgentePolizas> generateReporteAgenteByRutPolizas(Integer rut_agente, Integer rowdesde, Integer rowhasta);
    ...
    String crearCartolaPoliza(int rut, String nombre, String email, int rut_usuario, String nombre_usuario, Date fechaini, Date fechafin, int tipo);
    String crearCartolaDividendo(int rut, String nombre, String email, int rut_usuario, String nombre_usuario, Date fechaini, Date fechafin, int tipo);
    ...
    List<RecaudacionByEmpMedioInPeriod> findLastRecaudacionByEmpresaMediobyRango(Integer cod_empresa, Integer cod_medio, Date fechamenor, Date fechamayor);
    List<BpiRtcRestrancuadrVw> findLastRecaudacionByEmpresainPeriodo(Date fechamenor, Date fechamayor, Long empresa);
    List<RecaudacionMedioByEmpresa> findLastRecaudacionMedioByEmpresainPeriodo(Integer id, Date fechamenor, Date fechamayor);
    List<RecaudacionMedioByEmpresa> findLastRecaudacionMedioByEmpresainPeriodoByMedio(Integer empresa, Date fechamenor, Date fechamayor, Integer cod_medio);
    ...
    List<BpiDttDettraturnoVw> findTransaccionesByEmpresaMedioByFecha(Integer cod_empresa, Integer cod_medio, Date fechaini, Date fechfin);
    ...
    List<RecaudacionByEmpMedioInPeriod> findLastRecaudacionByEmpresaMediobyCuad(Integer cod_empresa, Integer cod_medio, Long cuadratura);
    ...
    List<RecaudacionByEmpMedioInPeriod> findLastRecaudacionByEmpresaMedio(Integer cod_empresa, Integer cod_medio, Date fecha);        
    ...
    List<Navegacion> getCountFindNavegacionByRutInPeriod(Integer rut, Date fechadesde, Date fechahasta, Integer empresa);
    List<BpiCarCartolasTbl> getCountFindNavCartolasByRutInPeriod(Integer rut, Date fechaini, Date fechafin, Integer empresa);
    List<Navegacion> findNavegacionByRutInPeriod(Integer rut, Date fechaini, Date fechafin, Integer empresa);
    List<BpiCarCartolasTbl> findNavCartolasByRutInPeriod(Integer rut, Date fechaini, Date fechafin, Integer rowdesde, Integer rowhasta, Integer empresa);
    ...
    List<RecaudacionMedioByEmpresa> findLastRecaudacionMedioByEmpresainIdCudraturaByMedio(Integer empresa, Integer cuadratura, Integer cod_medio);
    List<RecaudacionByEmpMedioInPeriod> findLastRecaudacionByEmpresaMediobyRangoByMedio2(Integer cod_empresa, Integer cod_medio, Date fechamenor, Date fechamayor, Integer cod_medio2);
    List<RecaudacionByEmpMedioInPeriod> findLastRecaudacionByEmpresaMediobyCuadByMedio2(Integer cod_empresa, Integer cod_medio, Long cuadratura, Integer cod_medi2);
    List<TransaccionMedioByEmpresaByMedio2> findTransaccionesRecauByMedio2ByFecha(Timestamp fechaini, Timestamp fechafin, Integer empresa);
    List<TransaccionMedioByEmpresaByMedio2> findTransaccionesRecauByMedio2ByCuadratura(Integer idcuadratura, Integer empresa);
    DetalleAPV getDetalleProductoAPV(String poliza);
    boolean updateEstadoPolizaAPV(Long rut_trabajador, Long numero_poliza, Long ramo, Long numero_recibo, Long secuencia);
    ...
    String generaXmlResumenPagosConProductosSeleccionadosAPVAPT(String xml, ResumenRequest req, int idCanal, int cargoTarjetaCredito);
    DetalleAPV generarIdAporteExtraordinarioAPV(DetalleAPV detalle);
    boolean updateIdAporteComprobantes(DetalleAPV detalle);
    String crearConfirmacionConXmlSeleccionadoAPT(String xmlResumenSeleccionado, int idCanal, int tipoTransaccion, int cargoExtra);
    
    boolean grabarDistribucionFondosAPVProducto(int idAporte, List<BpiDitribFondosAPVTbl> DistribfFondos, Long CodigoRegimen, String DescrpcionRegimen);
    List<BpiDitribFondosAPVTbl> getDistribucionFondosAPVByTransaccion(int idTransaccion, int poliza, int ramo, long rut);
    ...
    //PRIMERAS PRIMAS
    String crearResumenPagosPrimerasPrimas(Integer rut, String nombre, String confirmacion, int idCanal, Integer numeroPropuesta);
