...
public class RutUtil {
    ...
    public static String extractRut(String run) {
        logger.debug("extractRut(String run=" + run + ") - iniciando");
        String returnString = run.length() < 3 ? "0" : run.substring(0, run.length() - 2);
        logger.debug("extractRut(String run=" + run + ") - termina");
        return returnString;
    }
    ...
    public static String calculaDv(String rutSinDv) {
        logger.debug("calculaDv(String rutSinDv=" + rutSinDv + ") - iniciando");
        ...
        logger.debug("calculaDv(String rutSinDv=" + rutSinDv + ") - termina");
        return returnString;
    }
    ...
    public static String formateaRut(String run) {
		logger.debug("formateaRut(String run=" + run + ") - iniciando");
        ...
        if (run != null && run.length() > 3) {
            ...
            if (cantNumber > 3) {
                ...
                if (cantNumber > 3) {
					...
					logger.debug("formateaRut(String run=" + run + ") - termina");
                    return returnString;
                } else {
    ...
    public static String replaceCaracter(String texto, 
                                         ...
                                         String newText) {
		logger.debug("replaceCaracter(String texto=" + texto + ", String caracterToReplace=" + caracterToReplace + ", String newText=" + newText + ") - iniciando");
		...
		logger.debug("replaceCaracter(String texto=" + texto + ", String caracterToReplace=" + caracterToReplace + ", String newText=" + newText + ") - termina");
        return aux;
    }
    ...
    public static String desformateaRut(String run) {
        logger.debug("desformateaRut(String run=" + run + ") - iniciando");

        String returnString = RutUtil.replaceCaracter(run, ".", "");
        logger.debug("desformateaRut(String run=" + run + ") - termina");
        return returnString;
    }
    ...
    public static String replaceString(String buffer, String strIni, 
                                       String strMod) {
        logger.debug("replaceString(String buffer=" + buffer + ", String strIni=" + strIni + ", String strMod=" + strMod + ") - iniciando");
        ...
        out += aux2;
        logger.debug("replaceString(String buffer=" + buffer + ", String strIni=" + strIni + ", String strMod=" + strMod + ") - termina");
        return out;
    }
