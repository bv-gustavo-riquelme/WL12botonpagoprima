...
public class StringUtil {
    ...
    public static String replaceString(String buffer, String strIni, String strMod) {
        logger.info("replaceString(String buffer, String strIni=" + strIni + ", String strMod=" + strMod + ") - iniciando");
        ...
        out += aux2;
        logger.info("replaceString(String buffer, String strIni=" + strIni + ", String strMod=" + strMod + ") - termina");
        return out;
    }
