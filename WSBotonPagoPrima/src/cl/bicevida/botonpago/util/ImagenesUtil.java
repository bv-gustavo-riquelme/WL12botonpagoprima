...
public class ImagenesUtil {
    ...
    public static void generarTimbrePagado(String fecha, String formato, URL urlfileoriginal, String fileabsolutepath) throws IOException {
        logger.info("generarTimbrePagado(String fecha=" + fecha + ", String formato=" + formato + ", String fileabsolutepath=" + fileabsolutepath + ") - iniciando");    
        ...
        ImageIO.write(nuevo, formato, new FileOutputStream(fileabsolutepath));
        logger.info("generarTimbrePagado(String fecha=" + fecha + ", String formato=" + formato + ", String fileabsolutepath=" + fileabsolutepath + ") - termina");
    }


    public static BufferedImage rotate (BufferedImage bi, double degrees, Color backgroundColor)    {
            logger.info("rotate(BufferedImage bi=" + bi + ", double degrees=" + degrees + ", Color backgroundColor=" + backgroundColor + ") - iniciando");
            ...
            logger.info("rotate(BufferedImage bi=" + bi + ", double degrees=" + degrees + ", Color backgroundColor=" + backgroundColor + ") - termina");
            return newbi;
    }
